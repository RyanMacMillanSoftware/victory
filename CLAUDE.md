...
**YOU ARE IN: `victory/polecats/guzzle/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/victory/` (rig root) or other directories
...
**Your mail address:** `victory/polecats/guzzle`
**Your rig:** victory
**Your Witness:** `victory/witness`
...
| Ask Witness for help | `gt mail send victory/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`victory/witness`) when:
...
```bash
gt mail send victory/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
